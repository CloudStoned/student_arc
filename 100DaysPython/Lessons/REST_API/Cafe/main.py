...
class Base(DeclarativeBase):
    pass
# Connect to Database
app.config['SQLALCHEMY_DATABASE_URI'] = "sqlite:///C:/Users/Kraum/PROJECTS/100DaysPython/REST_API/instance/cafes.db"
...
def delete_cafe(cafe_id):
    ...
    if api_key == "TopSecretAPIKey":
        ...
        return jsonify (error = {
            "Forbidden": "Sorry, that is not allowed. Make sure you have the correct api_key. "
        }), 403
