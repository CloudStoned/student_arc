...
void user::loginName()
{
    ...
    system("Color 01");
    cout << mainDesign();
    cout << "Enter Account Name (Press 0 to back): ";
...
void user::loginPin()
{
    ...
    system("cls");
    cout << mainDesign();
    cout << "Enter pin (Press 0 to back): ";
...
void user::balanceMenu()
{
    ...
    cout << mainDesign();
    cout << "|                                                                  |"<< endl;
    cout << fixed << setprecision(2) << "|                    Your balance is " << getBalance() << " pesos.                   " << endl; 
...
void user::depositMenu()
{
    ...
    cout << "|                                                                  |"<< endl;
    cout << "--------------------------------------------------------------------" << endl;
    cout << "Enter amount to deposit (Press 0 to back): ";
    cin >> depositString;
    ...
    if (depositFlag == 0)
    {
        ...
        if (depositInt <= 499)
        {
            ...
            cout << mainDesign();
            cout << "|                                                                  |"<< endl;
            cout << fixed << setprecision(2) << "|                  Your new balance is: PHP " << getBalance() << "                 " << endl;
            cout << "|                   As of " << getTime() << "                 |" << endl;
            cout << "|                                                                  |"<< endl;
            cout << "--------------------------------------------------------------------" << endl;
            cout << endl << "";
...
void user::savingBalance()
{
    ...
    for (int i = 0; i < accountDetails.size(); i++)
    {
        ...
        if(i != 5)
        {
            ...
            writeFile << fixed << setprecision(2) << getBalance() << endl;
...
void user::withdrawMenu()
{
    ...
    cout << "|                                                                  |"<< endl;
    cout << "--------------------------------------------------------------------" << endl;
    cout << "Enter amount to withdraw (Press 0 to back): ";
    cin >> withdrawString;
...
void user::changePinScreen()
{
    ...
    cout << "|                                                                  |"<< endl;
    cout << "--------------------------------------------------------------------" << endl;
    cout << "Enter current pin (Press 0 to back): ";
    inputPin = takePasswdFromUser();
    ...
    else if (inputPin == userPin)
    {
        ...
        while(updatePin.length() != 4 || updatePin == inputPin || stringCheck(updatePin) == false)
        {
            ...
            system("cls");
            cout << mainDesign();
            cout << "Enter new 4-digit pin (Press 0 to back): ";
        ...
        while(choose != "Y" && choose != "y" && choose != "N" && choose != "n")
        {
            ...
            cout << mainDesign();
            cout << "|                                                                  |"<< endl;
            cout << "|                   Change current pin to new pin?                 |" << endl;
            cout << "|                                                                  |"<< endl;
            cout << "--------------------------------------------------------------------" << endl;
            cout << "Enter Y or N: ";
            getline(cin, choose);
...
void admin::get_acctype()
{
    ...
    cout << "|                                                                  |";
    cout << "\n--------------------------------------------------------------------\n";
    cout << "Enter number (Press 0 to back): ";
    getline(cin, pick);
...
void admin::delaccnt()
{
    ...
    if (filedelete.is_open())
    {
        ...
        if (delaccnt_ask2() == 1)
        {
            ...
            //READ ACCNTNAMES.TXT
            ifstream readFile1("AccountNames.txt");
            
            vector<string> accountDetails1;
            string line1; 

            while (getline(readFile1, line1))
            {

                accountDetails1.push_back(line1);

            }
            
            readFile1.close();
            
            //END OF ACCNTNAMES.TXT

            //change accnames.txt
            ofstream writeFile1("AccountNames.txt");

            transform(accname.begin(), accname.end(), accname.begin(), :: toupper);

            for (int i = 0; i < accountDetails1.size(); i++)
            {

                if (accountDetails1[i] != accname)//ilalagay yung mga hindi papalitan
                {
                    writeFile1 << accountDetails1[i] << endl; 
                }

                else if (accountDetails1[i] == accname)
                {
                    continue;
                }
...
int admin::delaccnt_ask2()
{
    ...
    cout << banner();
    cout << "|                                                                  |" << endl;
	cout << "|          All details with this account will be deleted.          |"<< endl;
...
void admin::change_accname()
{
	...
	//READ
    ifstream readFile("DATA\\" + oldaccname + ".txt");
    ...
    cout << "|                                                                  |";
    cout << "\n--------------------------------------------------------------------\n";
	cout << "Enter New Account Name (Press 0 to back): ";
    system ("Color 01");
    ...
    if (change_accname_ask() == 1)
    {
        ...
        transform(accname.begin(), accname.end(), accname.begin(), :: toupper);    
        transform(newaccname.begin(), newaccname.end(), newaccname.begin(), :: toupper);
        ...
        for (int i = 0; i < accountDetails1.size(); i++)
        {
            ...
            transform(oldaccname.begin(), oldaccname.end(), oldaccname.begin(), :: toupper);

            if (accountDetails1[i] != oldaccname)//ilalagay yung mga hindi papalitan
            {
                writeFile1 << accountDetails1[i] << endl; 
            }

            else if (accountDetails1[i] == oldaccname)
                writeFile1 << newaccname << endl;
                //DITO NA MAGPAPALIT
        }   
            //end accnames.txt
        ...
        string deleteaccname;

        deleteaccname.append("DATA\\" + accname + ".txt");
...
void admin::change_acctype()
{
    ...
    cout << "|                                                                  |"<< endl;
    cout << "--------------------------------------------------------------------" << endl;
	cout << "Enter 1 or 2 only (Press 0 to back): ";
    system("Color 01");
	getline(cin, newacctype);
    ...
    if (newacctype != "1" && newacctype != "2" && newacctype != "Savings" && newacctype != "Current")
    {
    ...
    while(choose != "Y" && choose != "y" && choose != "N" && choose != "n")
    {
        ...
        cout << banner();
        cout << "|                                                                  |"<< endl;
        cout << "|                    Change account type to " << newacctype << "?               |" << endl;
        cout << "|                                                                  |"<< endl;
        cout << "--------------------------------------------------------------------" << endl;
        cout << "Enter Y or N: ";
        getline(cin, choose);
...
void admin::check_initial_depo()
{
    ...
    system ("Color 01");
    cout << banner();
    cout << "Enter Initial Deposit (Press 0 to back): ";
    cin >> initial_depo;
...
void admin::put_to_db_acctype_depo(ofstream& f)
{
	...
	f << depo << endl << depo <<  "\t\t" << "D" << "\t\t" << ctime(&currentTime); 
